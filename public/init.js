...
you're gonna see some serious shit.	*/
  ...
  function render() {
    ...
    // Define la matriz de colores permitidos
    var allowedColors = [
      0xceff00, // #ceff00
      0xfbffea, // #fbffea
      0x111111, // #111111
    ...
    for (i = 0; i < materials.length; i++) {
      // Obtén el índice del color de la matriz permitida
      var colorIndex = i % allowedColors.length;

      // Obtén el color actual de la matriz permitida
      var colorHex = allowedColors[colorIndex];

      // Crea un color THREE.Color a partir del valor hexadecimal
